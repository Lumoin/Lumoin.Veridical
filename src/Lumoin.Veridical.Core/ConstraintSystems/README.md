...
`R1csPipeWriterDelegate` (the reader direction has concrete
implementations — Circom, ZkInterface — while the writer delegate has
none in this library). Adapters live outside this
library — in separate
