...
/// the same curve; that agreement is checked at runtime because the leaf
/// types carry no per-curve type parameter to guarantee it at compile time.
/// The Fp12 target type is unified across curves rather than split per curve,
/// consistent with the curve-broad design this library's extension blocks
/// use elsewhere.
/// </para>
/// </remarks>
...
{
    /// <summary>Pairing members added to every <see cref="G1Point"/> instance.</summary>
    extension(G1Point p)
    {
        /// <summary>
