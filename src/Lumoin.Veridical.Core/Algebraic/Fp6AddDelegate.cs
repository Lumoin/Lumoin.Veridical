...
/// <summary>
/// Computes the canonical-form sum of two Fp6 extension-field elements
/// over the curve identified by <paramref name="curve"/>, writing the
/// result into <paramref name="result"/>.
/// </summary>
/// <param name="a">The left operand in canonical <c>[c0 : 96 bytes][c1 : 96 bytes][c2 : 96 bytes]</c> layout.</param>
...
/// <remarks>
/// Addition in Fp6 is componentwise on the three Fp2 coefficients.
/// </remarks>
public delegate void Fp6AddDelegate(
    ReadOnlySpan<byte> a,
    ReadOnlySpan<byte> b,
    Span<byte> result,
