...
/// <summary>
/// Computes the canonical-form difference <c>a − b</c> of two Fp6
/// extension-field elements over the curve identified by
/// <paramref name="curve"/>, writing the result into <paramref name="result"/>.
/// </summary>
/// <param name="a">The minuend in canonical Fp6 layout.</param>
/// <param name="b">The subtrahend in canonical Fp6 layout.</param>
...
/// <remarks>
/// Subtraction is componentwise on the three Fp2 coefficients.
/// </remarks>
public delegate void Fp6SubtractDelegate(
    ReadOnlySpan<byte> a,
    ReadOnlySpan<byte> b,
    Span<byte> result,
