...
{
    /// <summary>Path-construction members added to every <see cref="MerkleTree"/> instance.</summary>
    extension(MerkleTree tree)
    {
        ...
        public MerkleAuthenticationPath BuildPath(int leafIndex, BaseMemoryPool pool)
        {
