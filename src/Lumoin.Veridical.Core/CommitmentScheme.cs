...
public readonly struct CommitmentScheme: IEquatable<CommitmentScheme>
{
    ...
    /// <summary>
    /// Ligero. Transparent, hash-based multilinear polynomial commitment over
    /// interleaved Reed-Solomon codes with a tensor-query evaluation argument;
    /// needs no trusted setup and runs over fields without smooth-order roots of
    /// unity. Pairs with sumcheck-based proof systems.
    /// </summary>
