...
public static class MaskedSpartanProverExtensions
{
    extension(MaskedSpartanProver prover)
    {
        ...
        private static ZkBaseFoldMaskedSpartanProof AssembleZkBaseFoldProof(
            PolynomialCommitmentProvider pcs, MaskedProofComponents c, SensitiveMemoryPool<byte> p)
        {
        ...
        private TProof ProveMaskedCore<TProof>(
            ...
            Func<PolynomialCommitmentProvider, MaskedProofComponents, SensitiveMemoryPool<byte>, TProof> assemble)
        {
    ...
    private static Scalar[] ToScalarArray(IReadOnlyList<Scalar> source, SensitiveMemoryPool<byte> pool)
    {
