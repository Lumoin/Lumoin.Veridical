...
public static class MaskedSpartanVerifierExtensions
{
    extension(MaskedSpartanVerifier verifier)
    {
        ...
        /// <see cref="VerifyBaseFold(BaseFoldMaskedSpartanProof, RelaxedR1csInstance, FiatShamirTranscript, ScalarAddDelegate, ScalarMultiplyDelegate, ScalarSubtractDelegate, ScalarInvertDelegate, ScalarReduceDelegate, FiatShamirHashDelegate, FiatShamirSqueezeDelegate, SensitiveMemoryPool{byte})"/>
