...
public static class SpartanProofExtensions
{
    extension(SpartanProof proof)
    {
        ...
        public (Scalar Az, Scalar Bz, Scalar Cz) GetOuterClaims(SensitiveMemoryPool<byte> pool)
        {
        ...
        /// </summary>
        public Scalar GetEvalW(SensitiveMemoryPool<byte> pool)
        {
            ArgumentNullException.ThrowIfNull(proof);
            ArgumentNullException.ThrowIfNull(pool);
        ...
        /// </summary>
        public CompressedRoundPolynomial GetOuterSumcheckRound(int roundIndex, SensitiveMemoryPool<byte> pool)
        {
            ArgumentNullException.ThrowIfNull(proof);
            ArgumentNullException.ThrowIfNull(pool);
        ...
        /// as a fresh <see cref="CompressedRoundPolynomial"/>.
        /// </summary>
        public CompressedRoundPolynomial GetInnerSumcheckRound(int roundIndex, SensitiveMemoryPool<byte> pool)
        {
            ArgumentNullException.ThrowIfNull(proof);
            ArgumentNullException.ThrowIfNull(pool);
