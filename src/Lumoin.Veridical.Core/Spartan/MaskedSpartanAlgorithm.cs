...
internal static class MaskedSpartanAlgorithm
{
    ...
    {
        /// <summary>The masked outer sumcheck's per-round compressed messages, in round order.</summary>
        public IReadOnlyList<SumcheckRound> Rounds { get; }

        /// <summary>The outer sumcheck's challenge vector <c>r_x</c>, one per round, in round order.</summary>
        public IReadOnlyList<Scalar> Challenges { get; }

        /// <summary>The base <c>Az</c> MLE folded down to its terminal evaluation at <c>r_x</c>.</summary>
        public Scalar TerminatingAz { get; }

        /// <summary>The base <c>Bz</c> MLE folded down to its terminal evaluation at <c>r_x</c>.</summary>
        public Scalar TerminatingBz { get; }

        /// <summary>The base <c>Cz</c> MLE folded down to its terminal evaluation at <c>r_x</c>.</summary>
        public Scalar TerminatingCz { get; }

        /// <summary>The error MLE <c>E</c> folded down to its terminal evaluation at <c>r_x</c>.</summary>
        public Scalar TerminatingE { get; }

        /// <summary>Wraps the already-computed rounds, challenges and terminating evaluations a masked outer sumcheck run produced.</summary>
        ...
        /// <summary>Disposes every round, challenge and terminating evaluation this result owns.</summary>
        public void Dispose()
        {
    ...
    {
        /// <summary>The masked inner sumcheck's per-round compressed messages, in round order.</summary>
        public IReadOnlyList<SumcheckRound> Rounds { get; }

        /// <summary>The inner sumcheck's challenge vector <c>r_y</c>, one per round, in round order.</summary>
        public IReadOnlyList<Scalar> Challenges { get; }

        /// <summary>The batched <c>ABC</c> slice MLE folded down to its terminal evaluation at <c>r_y</c>.</summary>
        public Scalar TerminatingAbc { get; }

        /// <summary>The <c>z</c> assignment MLE folded down to its terminal evaluation at <c>r_y</c>.</summary>
        public Scalar TerminatingZ { get; }

        /// <summary>Wraps the already-computed rounds, challenges and terminating evaluations a masked inner sumcheck run produced.</summary>
