...
internal static class P256EcdsaReference
{
    ...
    private static ScalarMultiplyDelegate ScalarMul { get; } = P256BigIntegerScalarReference.GetMultiply();
    ...
    private static G1ScalarMultiplyDelegate PointMul { get; } = P256ConstantTimeG1Backend.GetScalarMultiply();
    private static G1AddDelegate PointAdd { get; } = P256BigIntegerG1Reference.GetAdd();
