...
public static class ZkBaseFoldMaskedSpartanSimulator
{
    ...
    private static Scalar ReduceRecorded(ProgrammableFiatShamirOracle oracle, int index, ScalarReduceDelegate reduce, CurveParameterSet curve, BaseMemoryPool pool)
    {
