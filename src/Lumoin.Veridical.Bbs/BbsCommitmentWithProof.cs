...
public sealed class BbsCommitmentWithProof: SensitiveMemory
{
    ...
    private static Tag AlgebraicTagSha256Pseudonym { get; } = Tag.Create(AlgebraicRole.ZkProof)
        .With(CurveParameterSet.Bls12Curve381)
        .With(BbsCiphersuite.Bls12Curve381Sha256Pseudonym);

    private static Tag AlgebraicTagShake256Pseudonym { get; } = Tag.Create(AlgebraicRole.ZkProof)
        .With(CurveParameterSet.Bls12Curve381)
