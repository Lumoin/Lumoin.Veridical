...
/// <summary>
/// Byte-equality tests for the BLS12-381-SHA-256 generator
...
/// </summary>
[TestClass]
internal sealed class Sha256GeneratorsTests
{
    public static IEnumerable<object[]> VectorsData =>
        Sha256GeneratorsVectors.All.Select(v => new object[] { v });


    [TestMethod]
    [DynamicData(nameof(VectorsData))]
    public void Generators_Bls12Curve381Sha256(GeneratorsVector vector)
    {
        BbsCiphersuite ciphersuite = BbsCiphersuite.Bls12Curve381Sha256;
