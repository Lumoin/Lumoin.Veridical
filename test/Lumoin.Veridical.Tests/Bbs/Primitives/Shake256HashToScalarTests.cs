...
/// <summary>
/// Byte-equality tests for the BLS12-381-SHAKE-256 hash-to-scalar
/// primitive against the upstream <c>h2s.json</c> fixture.
/// </summary>
[TestClass]
internal sealed class Shake256HashToScalarTests
{
    public static IEnumerable<object[]> VectorsData =>
        Shake256HashToScalarVectors.All.Select(v => new object[] { v });


    [TestMethod]
    [DynamicData(nameof(VectorsData))]
    public void HashToScalar_Bls12Curve381Shake256(HashToScalarVector vector)
    {
        ...
        using Scalar scalar = Scalar.FromHashToScalar(
            message,
            dst,
            TestSetup.Shake256.HashToScalar, CurveParameterSet.Bls12Curve381, TestSetup.Pool);
