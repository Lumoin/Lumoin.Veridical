...
/// <summary>
/// Deterministic random-scalars primitive vectors for the BLS12-381-SHA-256 ciphersuite.
/// </summary>
internal static class Sha256BbsDeterministicScalarsVectors
{
    /// <summary>
    /// Deterministic random scalars (count = 10).
    /// </summary>
    public static BbsDeterministicScalarsVector Vector001 { get; } = new(
        Id: "sha256-mocked-rng-001",
    ...
    /// <summary>Every Sha256 deterministic random-scalars primitive vector currently transcribed.</summary>
