...
/// <summary>
/// Generator-derivation primitive vectors for the BLS12-381-SHAKE-256 ciphersuite.
/// </summary>
internal static class Shake256GeneratorsVectors
{
    /// <summary>
    /// Generators fixture for ten message generators (L = 10) plus Q_1 plus the ciphersuite-fixed P_1.
    /// </summary>
    public static GeneratorsVector Vector001 { get; } = new(
        Id: "shake256-generators-001",
        Description: "Generators fixture (L = 10)",
    ...
    /// <summary>Every Shake256 generators primitive vector currently transcribed.</summary>
    public static IReadOnlyList<GeneratorsVector> All { get; } = new[] { Vector001 };
}