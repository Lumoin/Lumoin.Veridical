...
/// <summary>
/// Deterministic random-scalars primitive vectors for the BLS12-381-SHAKE-256 ciphersuite.
/// </summary>
internal static class Shake256BbsDeterministicScalarsVectors
{
    /// <summary>
    /// Deterministic random scalars (count = 10).
    /// </summary>
    public static BbsDeterministicScalarsVector Vector001 { get; } = new(
        Id: "shake256-mocked-rng-001",
        Description: "mocked random scalars",
    ...
    /// <summary>Every Shake256 deterministic random-scalars primitive vector currently transcribed.</summary>
    public static IReadOnlyList<BbsDeterministicScalarsVector> All { get; } = new[] { Vector001 };
}