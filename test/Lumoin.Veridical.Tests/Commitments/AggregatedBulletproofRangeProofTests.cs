...
(RangeProof proof, IMemoryOwner<byte> commitmentsOwner, int commitmentBytes, RangeProofKey key) = Prove(BitWidth, values, out BaseMemoryPool pool);
...
(RangeProof proof, IMemoryOwner<byte> commitmentsOwner, int commitmentBytes, RangeProofKey key) = Prove(bitWidth, values, out BaseMemoryPool pool);
    ...
    private static (RangeProof Proof, IMemoryOwner<byte> Commitments, int CommitmentBytes, RangeProofKey Key) Prove(int bitWidth, ulong[] values, out BaseMemoryPool pool)
    {
