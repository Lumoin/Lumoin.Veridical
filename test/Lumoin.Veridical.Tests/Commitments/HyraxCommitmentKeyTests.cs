...
internal sealed class HyraxCommitmentKeyTests
{
    ...
    {
        using HyraxCommitmentKey first = HyraxCommitmentKey.Derive(8, WellKnownHyraxDomainLabels.CanonicalSeedV1, CurveParameterSet.Bls12Curve381, HashToCurve, BaseMemoryPool.Shared);
        using HyraxCommitmentKey second = HyraxCommitmentKey.Derive(8, WellKnownHyraxDomainLabels.CanonicalSeedV1, CurveParameterSet.Bls12Curve381, HashToCurve, BaseMemoryPool.Shared);
    ...
    {
        using HyraxCommitmentKey first = HyraxCommitmentKey.Derive(4, "veridical.test.protocolA.v1", CurveParameterSet.Bls12Curve381, HashToCurve, BaseMemoryPool.Shared);
        using HyraxCommitmentKey second = HyraxCommitmentKey.Derive(4, "veridical.test.protocolB.v1", CurveParameterSet.Bls12Curve381, HashToCurve, BaseMemoryPool.Shared);
    ...
    {
        using HyraxCommitmentKey key = HyraxCommitmentKey.Derive(8, WellKnownHyraxDomainLabels.CanonicalSeedV1, CurveParameterSet.Bls12Curve381, HashToCurve, BaseMemoryPool.Shared);
