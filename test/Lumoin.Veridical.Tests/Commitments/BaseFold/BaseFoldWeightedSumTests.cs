...
internal sealed class BaseFoldWeightedSumTests
{
    ...
    private static Scalar DirectWeightedSum(MultilinearExtension mle, MultilinearExtension multiplier, SensitiveMemoryPool<byte> pool)
    {
    ...
    private static MerkleRoot ComputeCommitment(FoldableCode code, MultilinearExtension mle, SensitiveMemoryPool<byte> pool)
    {
    ...
    private static MerkleRoot ComputeSaltedCommitment(FoldableCode code, MultilinearExtension mle, ReadOnlySpan<byte> salts, SensitiveMemoryPool<byte> pool)
    {
        FoldableCodeParameters parameters = code.Parameters;
        int messageElements = parameters.MessageLength;
        int codewordElements = parameters.CodewordLength;
