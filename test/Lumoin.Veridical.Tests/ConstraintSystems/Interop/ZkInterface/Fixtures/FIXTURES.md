...
Spartan over a real curve uses the owned BLS/BN254 `.zkif` fixtures,
committed as reference-computed bytes.

## `multiplier2.zkif` — owned BLS12-381 / BN254 fixtures

| Fixture | SHA-256 |
|---------|---------|
| `bls12_381/multiplier2.zkif` | `c9b92cabbb5244d2c03bdec45e673ec5ec60e1748b77173b1bcfad771289635a` |
| `bn254/multiplier2.zkif` | `c6f1fb5a1caa8f987853450651dab11febc1d340b5fcd673080037f7cc4d8321` |
