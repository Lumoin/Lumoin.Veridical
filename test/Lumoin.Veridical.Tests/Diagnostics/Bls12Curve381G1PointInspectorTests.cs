...
internal sealed class Bls12Curve381G1PointInspectorTests
{
    ...
    {
        using G1Point generator = G1Point.Generator(CurveParameterSet.Bls12Curve381, SensitiveMemoryPool<byte>.Shared);
    ...
    public void InspectingPointWithYParityFlagSetReportsYParityFlagSet()
    {
        ...
        using G1Point withParityFlagSet = G1Point.FromCanonical(bytes, CurveParameterSet.Bls12Curve381, SensitiveMemoryPool<byte>.Shared);
