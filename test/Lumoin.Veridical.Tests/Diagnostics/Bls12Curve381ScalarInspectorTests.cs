...
internal sealed class Bls12Curve381ScalarInspectorTests
{
    ...
    public void InspectingZeroScalarReportsIsZeroAndCanonical()
    {
        ...
        using Scalar scalar = Scalar.FromCanonical(zeroBytes, CurveParameterSet.Bls12Curve381, BaseMemoryPool.Shared);
    ...
    public void InspectingOneScalarReportsIsOneAndCanonical()
    {
        ...
        using Scalar scalar = Scalar.FromCanonical(oneBytes, CurveParameterSet.Bls12Curve381, BaseMemoryPool.Shared);
    ...
    public void InspectingAllOnesBytesReportsNotInCanonicalRange()
    {
        ...
        using Scalar scalar = Scalar.FromCanonical(allOnes, CurveParameterSet.Bls12Curve381, BaseMemoryPool.Shared);
    ...
    public void InspectingScalarFieldOrderExactlyReportsNotInCanonicalRange()
    {
        ...
        using Scalar scalar = Scalar.FromCanonical(scalarFieldOrderBytes, CurveParameterSet.Bls12Curve381, BaseMemoryPool.Shared);
