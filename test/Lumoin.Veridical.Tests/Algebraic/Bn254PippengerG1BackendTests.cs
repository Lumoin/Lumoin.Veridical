...
/// <summary>
/// Agreement gates for the BN254 Pippenger G1 multi-scalar multiplication: the
...
/// </summary>
[TestClass]
internal sealed class Bn254PippengerG1BackendTests
{
    ...
    public void CachingDelegateAgreesAcrossRepeatAndMutatedCalls()
    {
        ...
        const int Count = 9;
        G1MultiScalarMultiplyDelegate caching = Bn254PippengerG1Backend.CreateCachingMultiScalarMultiply();
