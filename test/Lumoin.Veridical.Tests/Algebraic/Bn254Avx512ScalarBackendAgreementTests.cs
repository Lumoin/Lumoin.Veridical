...
internal sealed class Bn254Avx512ScalarBackendAgreementTests
{
    ...
    {
        AssertRejectsOversizedBuffer(Bn254Avx512ScalarBackend.GetBatchAdd().Invoke, oversizedOperand);
    }
    ...
    {
        AssertRejectsOversizedBuffer(Bn254Avx512ScalarBackend.GetBatchSubtract().Invoke, oversizedOperand);
    }
    ...
    {
        AssertRejectsOversizedBuffer(Bn254Avx512ScalarBackend.GetBatchMultiply().Invoke, oversizedOperand);
    }
    ...
    public void Avx512OperationsIncrementExactCounts()
    {
        ...
        try
        {
            ...
            Bn254Avx512ScalarBackend.GetAdd()(one, one, result, Curve);
            Bn254Avx512ScalarBackend.GetSubtract()(one, one, result, Curve);
            Bn254Avx512ScalarBackend.GetMultiply()(one, one, result, Curve);
            Bn254Avx512ScalarBackend.GetNegate()(one, result, Curve);
            Bn254Avx512ScalarBackend.GetInvert()(one, result, Curve);
            Bn254Avx512ScalarBackend.GetBatchAdd()(leftBatch, rightBatch, batchResult, TelemetryCount, Curve);
            Bn254Avx512ScalarBackend.GetBatchSubtract()(leftBatch, rightBatch, batchResult, TelemetryCount, Curve);
            Bn254Avx512ScalarBackend.GetBatchMultiply()(leftBatch, rightBatch, batchResult, TelemetryCount, Curve);
    ...
    private static void AssertSubtractMatchesReference(BigInteger leftValue, BigInteger rightValue, BigInteger expectedValue)
    {
        ...
        Bn254Avx512ScalarBackend.GetSubtract()(left, right, result, Curve);
