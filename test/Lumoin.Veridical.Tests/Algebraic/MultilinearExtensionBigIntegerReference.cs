...
/// scratch buffer from <see cref="BaseMemoryPool.Shared"/> and
...
internal static class MultilinearExtensionBigIntegerReference
{
        ...
        CurveParameterSet curve)
    {
        ...
        using IMemoryOwner<byte> bufferAOwner = BaseMemoryPool.Shared.Rent(maxBufferSize);
        using IMemoryOwner<byte> bufferBOwner = BaseMemoryPool.Shared.Rent(maxBufferSize / 2);
