...
internal sealed class FiatShamirTranscriptDomainSeparationTests
{
    ...
    public void DifferentDomainLabelsProduceDifferentChallenges()
    {
        ...
        using FiatShamirTranscript a = FiatShamirTranscript.Initialise(domainA, seed, WellKnownHashAlgorithms.Blake3, Hash, SensitiveMemoryPool<byte>.Shared);
        using FiatShamirTranscript b = FiatShamirTranscript.Initialise(domainB, seed, WellKnownHashAlgorithms.Blake3, Hash, SensitiveMemoryPool<byte>.Shared);
    ...
    public void DifferentOperationLabelsProduceDifferentStatesPostAbsorb()
    {
        ...
        using FiatShamirTranscript a = FiatShamirTranscript.Initialise(domain, seed, WellKnownHashAlgorithms.Blake3, Hash, SensitiveMemoryPool<byte>.Shared);
        using FiatShamirTranscript b = FiatShamirTranscript.Initialise(domain, seed, WellKnownHashAlgorithms.Blake3, Hash, SensitiveMemoryPool<byte>.Shared);
