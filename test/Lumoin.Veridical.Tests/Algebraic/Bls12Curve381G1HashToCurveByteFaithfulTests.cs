...
internal sealed class Bls12Curve381G1HashToCurveByteFaithfulTests
{
    ...
    public void HashToCurveProducesPublishedCompressedEncoding(Rfc9380J9_1Vector vector)
    {
        ...
        using G1Point produced = G1Point.FromHashToCurve(
            msg,
            dst,
            hashToCurve, CurveParameterSet.Bls12Curve381, SensitiveMemoryPool<byte>.Shared);
    ...
    public void Sha256AndShake256HashToCurveProduceDifferentPoints()
    {
        ...
        using G1Point pSha = G1Point.FromHashToCurve(message, dst, sha, CurveParameterSet.Bls12Curve381, SensitiveMemoryPool<byte>.Shared);
        using G1Point pShake = G1Point.FromHashToCurve(message, dst, shake, CurveParameterSet.Bls12Curve381, SensitiveMemoryPool<byte>.Shared);
