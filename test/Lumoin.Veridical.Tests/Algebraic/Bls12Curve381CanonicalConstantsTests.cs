...
internal sealed class Bls12Curve381CanonicalConstantsTests
{
    ...
    private static BigInteger CanonicalBaseFieldPrime { get; } = BigInteger.Parse(
    ...
    private static BigInteger CanonicalScalarFieldOrder { get; } = BigInteger.Parse(
        "73eda753299d7d483339d80809a1d80553bda402fffe5bfeffffffff00000001",
        NumberStyles.HexNumber,
        CultureInfo.InvariantCulture);

    //Canonical BLS12-381 G1 generator x-coordinate.
    private static BigInteger CanonicalGeneratorX { get; } = BigInteger.Parse(
        "17f1d3a73197d7942695638c4fa9ac0fc3688c4f9774b905a14e3a3f171bac586c55e83ff97a1aeffb3af00adb22c6bb",
        NumberStyles.HexNumber,
        CultureInfo.InvariantCulture);

    //Canonical BLS12-381 G1 generator y-coordinate.
    private static BigInteger CanonicalGeneratorY { get; } = BigInteger.Parse(
