...
internal sealed class Bn254Avx2ScalarBackendAgreementTests
{
    ...
    public void Avx2BatchMultiplyAgreesWithBigIntegerMultiply()
    {
        ...
        //Two complete SIMD groups and three trailing scalars exercise the batch body and tail.
        const int Count = 11;
    ...
    {
        AssertRejectsOversizedBuffer(Bn254Avx2ScalarBackend.GetBatchAdd().Invoke, oversizedOperand);
    }
    ...
    {
        AssertRejectsOversizedBuffer(Bn254Avx2ScalarBackend.GetBatchSubtract().Invoke, oversizedOperand);
    }
    ...
    {
        AssertRejectsOversizedBuffer(Bn254Avx2ScalarBackend.GetBatchMultiply().Invoke, oversizedOperand);
    }
    ...
    public void Avx2OperationsIncrementExactCounts()
    {
        ...
        try
        {
            ...
            Bn254Avx2ScalarBackend.GetAdd()(one, one, result, Curve);
            Bn254Avx2ScalarBackend.GetSubtract()(one, one, result, Curve);
            Bn254Avx2ScalarBackend.GetMultiply()(one, one, result, Curve);
            Bn254Avx2ScalarBackend.GetNegate()(one, result, Curve);
            Bn254Avx2ScalarBackend.GetInvert()(one, result, Curve);
            Bn254Avx2ScalarBackend.GetBatchAdd()(leftBatch, rightBatch, batchResult, TelemetryCount, Curve);
            Bn254Avx2ScalarBackend.GetBatchSubtract()(leftBatch, rightBatch, batchResult, TelemetryCount, Curve);
            Bn254Avx2ScalarBackend.GetBatchMultiply()(leftBatch, rightBatch, batchResult, TelemetryCount, Curve);
    ...
    private static void AssertSubtractMatchesReference(BigInteger leftValue, BigInteger rightValue, BigInteger expectedValue)
    {
        ...
        Bn254Avx2ScalarBackend.GetSubtract()(left, right, result, Curve);
        Bn254BigIntegerScalarReference.GetSubtract()(left, right, reference, Curve);
    ...
    {
        AssertBatchMatchesBigInteger(Bn254Avx2ScalarBackend.GetBatchAdd().Invoke, count, subtract: false);
    }
    ...
    {
        AssertBatchMatchesBigInteger(Bn254Avx2ScalarBackend.GetBatchSubtract().Invoke, count, subtract: true);
    }
