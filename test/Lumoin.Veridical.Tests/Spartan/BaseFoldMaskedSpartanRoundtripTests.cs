...
internal sealed class BaseFoldMaskedSpartanRoundtripTests
{
    ...
    private static BaseFoldMaskedSpartanProof Prove(SensitiveMemoryPool<byte> pool)
    {
    ...
    private static bool Verify(BaseFoldMaskedSpartanProof proof, SensitiveMemoryPool<byte> pool)
    {
