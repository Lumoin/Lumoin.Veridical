...
internal sealed class ZkBaseFoldMaskedSpartanRoundtripTests
{
    ...
    private static ZkBaseFoldMaskedSpartanProof Prove(SensitiveMemoryPool<byte> pool, ScalarArithmeticBackend? batch = null, MleFoldDelegate? mleFold = null)
    {
    ...
    private static bool Verify(ZkBaseFoldMaskedSpartanProof proof, SensitiveMemoryPool<byte> pool)
    {
