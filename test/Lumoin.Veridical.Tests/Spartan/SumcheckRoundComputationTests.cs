...
internal sealed class SumcheckRoundComputationTests
{
    ...
    public void OuterRoundPolynomialSatisfiesSumcheckClaimIdentity()
    {
        ...
        using IMemoryOwner<byte> azOwner = BaseMemoryPool.Shared.Rent(evaluationCount * elementSize);
        using IMemoryOwner<byte> bzOwner = BaseMemoryPool.Shared.Rent(evaluationCount * elementSize);
        using IMemoryOwner<byte> czOwner = BaseMemoryPool.Shared.Rent(evaluationCount * elementSize);
        using IMemoryOwner<byte> eqOwner = BaseMemoryPool.Shared.Rent(evaluationCount * elementSize);
        ...
        using Polynomial roundPoly = SumcheckRoundComputation.ComputeOuterRoundPolynomial(
            az, bz, cz, eq, VariableCount, Add, Subtract, Multiply, CurveParameterSet.Bls12Curve381, BaseMemoryPool.Shared);
    ...
    public void RelaxedOuterRoundReducesToStandardWhenUOneAndEZero()
    {
        ...
        using IMemoryOwner<byte> czOwner = BaseMemoryPool.Shared.Rent(evaluationCount * elementSize);
        using IMemoryOwner<byte> eqOwner = BaseMemoryPool.Shared.Rent(evaluationCount * elementSize);
        using IMemoryOwner<byte> eOwner = BaseMemoryPool.Shared.Rent(evaluationCount * elementSize);
        using IMemoryOwner<byte> uOwner = BaseMemoryPool.Shared.Rent(elementSize);
        ...
        using Polynomial relaxed = SumcheckRoundComputation.ComputeOuterRoundPolynomialRelaxed(
            az, bz, cz, e, eq, u, VariableCount, Add, Subtract, Multiply, CurveParameterSet.Bls12Curve381, BaseMemoryPool.Shared);
    ...
    public void InnerRoundPolynomialSatisfiesSumcheckClaimIdentity()
    {
        ...
        using IMemoryOwner<byte> abcOwner = BaseMemoryPool.Shared.Rent(evaluationCount * elementSize);
        using IMemoryOwner<byte> zOwner = BaseMemoryPool.Shared.Rent(evaluationCount * elementSize);
        ...
        using Polynomial roundPoly = SumcheckRoundComputation.ComputeInnerRoundPolynomial(
            abc, z, VariableCount, Add, Subtract, Multiply, CurveParameterSet.Bls12Curve381, BaseMemoryPool.Shared);
