...
internal sealed class BaseFoldSpartanRoundtripTests
{
    ...
    private static BaseFoldSpartanProof Prove(SensitiveMemoryPool<byte> pool)
    {
    ...
    private static bool Verify(BaseFoldSpartanProof proof, SensitiveMemoryPool<byte> pool)
    {
