...
/// against the xoofx native-FFI <c>Blake3</c> NuGet package.
/// </summary>
/// <remarks>
/// <para>
...
public class Blake3HashBenchmarks
{
    ...
    /// <summary>Benchmarks the xoofx native-FFI BLAKE3 implementation.</summary>
    [Benchmark(Description = "Xoofx (native FFI)")]
    public void Xoofx()
    {
